...
class ConsulterSujetPfa11 extends React.Component {
  constructor(props) {
    super(props)
 ...
 // detail() {
  ...
  //}
    ...
    render() {
      ...
      alignItems="center" >{  listItems = info.map((i) =>
        ...
        <Link to="/consulter-sujet/pfa1/detailpfa1"><p className="link"> voir plus >> </p></Link>
  ...
  export default ConsulterSujetPfa11;